...
VALUES (2, 250000, 1, NULL, 3, 1),
       (3, 150000, 2, 0.1, 3, 1),
       (1, 300000, 1, NULL, 4, 2);
	
-- product
INSERT INTO `product` (`name`, `price`, `description`, `quantity_per_unit`, `unit_in_stock`, `unit_in_orders`, `re_order_level`, `list_color`, `status`, `id_type`)
