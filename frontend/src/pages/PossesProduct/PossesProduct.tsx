...
export default function PossesProduct() {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    ...
                    <Link to={path.viewOrder} className="inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-center text-black bg-white rounded shadow hover:bg-slate-100 ml-8">
                      ViewOrder
                    </Link>
                  </div>
                </div>
